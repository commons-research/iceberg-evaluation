...
def compute_all_similarities(
    df: pd.DataFrame, msdata: MSData, output_mgf_path: T.Union[str, Path]
) -> Dict[str, list]:
...
def compute_pair_similarity(
    ...
    """
    Compute the similarity between two MSData embeddings.
    """
    return embedding1.similarity(embedding2).tolist()
